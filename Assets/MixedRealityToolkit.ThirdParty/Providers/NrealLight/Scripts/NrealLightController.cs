...
namespace MixedWorld.Nreal.Light.MixedReality.Toolkit.Input
{
    ...
    public class NrealLightController : BaseController
    {
        ...
        public override MixedRealityInteractionMapping[] DefaultInteractions => new[]
       {
        ...
        public override void SetupDefaultInteractions(Handedness controllerHandedness) => SetupDefaultInteractions();

        public override void SetupDefaultInteractions() => AssignControllerMappings(DefaultInteractions);
