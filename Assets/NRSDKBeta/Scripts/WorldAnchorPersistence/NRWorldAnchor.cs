...
namespace NRKernal.Beta.Persistence
{
    ...
    public class NRWorldAnchor : MonoBehaviour
    {
        ...
        {
#if UNITY_EDITOR
            return ConversionUtility.GetRelativePoseFromHead(anchorPos);
#else
            return ConversionUtility.GetRelativePoseFromHead(m_NativeInterface.GetAnchorPose(AnchorNativeHandle));
#endif
        }
