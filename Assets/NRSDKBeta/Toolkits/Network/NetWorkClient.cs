...
namespace NRKernal.Beta.NetWork
{
    ...
    public class NetWorkClient : IDisposable
    {
        ...
        private void HeartbeatResponse(byte[] data)
        {
            ...
            NRDebugger.Info("Receive a heart beat package.");
        }
        ...
        private void EnterRoomResponse(byte[] data)
        {
            ...
            if (result.result)
            {
                NRDebugger.Info("Join the room success.");
                OnJoinRoomResult?.Invoke(true);
            }
            else
            {
                NRDebugger.Info("Join the room faild.");
        ...
        private void ExitRoomResponse(byte[] data)
        {
            ...
            if (result.Suc)
            {
                NRDebugger.Info("Exit the room success.");
            }
            else
            {
                NRDebugger.Info("Exit the room faild.");
            }
        }
