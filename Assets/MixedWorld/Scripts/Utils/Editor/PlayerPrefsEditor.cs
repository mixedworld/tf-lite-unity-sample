...
namespace MixedWorld.Utils
{
    /// <summary>
    /// Player Prefs Editor Window Extension inspired by https://forum.unity.com/members/romejanic.363586/
    /// </summary>
    public class PlayerPrefsEditor : EditorWindow
    {

        [MenuItem("MixedWorld/Player Prefs")]
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("mixed.world");
